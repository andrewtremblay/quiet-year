...
export const RawCards: Card[] = [
  {
    ...
    name: "Ace of Spades",
    desc:
      "Now is the time to conserve energy and resources. A project fails, but gain an Abundance. or... Now is the time for hurried labour and final efforts. A project finishes early, but gain a Scarcity.",
  },
  {
    icon: "🂱",
    name: "Ace of Hearts",
    desc:
      "What group has the highest status in the community? What must people do to gain inclusion in this group? or... Are there distinct family units in the community? If so, what family structures are common?",
  },
  {
    icon: "🃁",
...
If there are no projects underway, the community becmoes obsessed with a grandioise vision. Hold a discussion about this vision, in addition to your regular action for the week.",
  },
  {
    ...
    name: "Two of Spades",
    desc:
      "A headstrong community member takes charge of the community’s work efforts. A project fails, and then a different project finishes early. or... A headstrong community member tries to take control of the community. How are they prevented from doing this? Due to the conflict, project dice are not reduced this week.",
  },
  {
    icon: "🂲",
    name: "Two of Hearts",
    desc:
      "There’s a large body of water on the map. Where is it? What does it look like? or... There’s a giant, man-made structure on the map. Where is it? Why is it abandoned?",
  },
  {
    icon: "🃂",
  ...
  },
  {
    ...
    desc:
      "Someone comes up with an ingenious solution to a big problem and as a result a project finishes early. What was their idea? or... Someone comes up with a plan to ensure safety and comfort during the coldest months. Start a project related to this.",
  },
  {
    icon: "🂳",
    name: "Three of Hearts",
    desc:
      "Someone new arrives. Who? or... Two of the community’s younger members get into a fight. What provoked them?",
  },
  {
    icon: "🃃",
    name: "Three of Diamonds",
    desc:
      "Summer is a time for production and tending to the earth. Start a project related to food production. or... Summer is a time for conquest and the gathering of might. Start a project related to military readiness and conquest.",
  },
  {
    icon: "🃓",
    name: "Three of Clubs",
    desc:
      "Someone leaves the community after issuing a dire warning. Who? What is the warning? or... Someone issues a dire warning, and the community leaps into action to avoid disaster. What is the warning? Start a contentious project that relates to it.",
  },
  {
    icon: "🂤",
    name: "Four of Spades",
    desc:
      "All the animals and young children are crying and won’t stop. Hold a discussion about this, in addition to your regular action for the week. or... A great atrocity is revealed. What is it? Who uncovers it?",
  },
  {
    icon: "🂴",
    name: "Four of Hearts",
    desc:
      "What important and basic tools does the community lack? or... Where are you storing your food? Why is this a risky place to store things?",
  },
  {
    icon: "🃄",
  ...
  },
  {
    ...
    name: "Five of Spades",
    desc:
      "Winter elements destroy a food source. If this was your only food source, add a Scarcity. or... Winter elements leave everyone cold, tired, and miserable. Project dice are not reduced this week.",
  },
  {
    icon: "🂵",
    name: "Five of Hearts",
    desc:
      "There is a disquieting legend about this place. What is it? or... Alarming weather patterns destroy something. How and what?",
  },
  {
    icon: "🃅",
    name: "Five of Diamonds",
    desc:
      "A project finishes early. What led to its early completion? or... The weather is nice and people can feel the potential all around them. Start a new project.",
  },
  {
    icon: "🃕",
    name: "Five of Clubs",
    desc:
      "The Parish arrives. Who are they? Why have they chosen your community, and for what? or... A small gang of marauders is making its way through local terrain. How many are there? What weapons do they carry?",
  },
  {
    icon: "🂦",
    name: "Six of Spades",
    desc:
      "The time has come to consolidate your efforts and your borders. Projects located outside the settlement fail, and all remaining projects are reduced by 2 this week. or... Someone finds a curious opportunity on the edge of the map. Start a project related to this discovery.",
  },
  {
    icon: "🂶",
    name: "Six of Hearts",
  ...
  },
  {
    ...
    desc:
      "Where does everyone sleep? Who is unhappy with this arrangement, and why? or... What natural predators roam this area? Are you safe?",
  },
  {
    icon: "🃇",
  ...
  },
  {
    ...
    name: "Seven of Clubs",
    desc:
      "A project just isn’t working out as expected. Radically change the nature of this project (don't modify the project die). When it resolves, you'll be responsible for telling the community how it went. or... Something goes foul and supplies are ruined. Add a new Scarcity.",
  },
  {
    icon: "🂨",
...
• Declare war on someone or... something. This counts as starting a project.",
  },
  {
    ...
    desc:
      "An old piece of machinery is discovered, broken but perhaps repairable. What is it? What would it be useful for? or... An old piece of machinery is discovered, cursed and dangerous. How does the community destroy it?",
  },
  {
    icon: "🃈",
  ...
  },
  {
    ...
    name: "Eight of Clubs",
    desc:
      "Someone sabotages a project, and the project fails as a result. Who did this? Why? or... Someone is caught trying to sabotage the efforts of the community. How does the community respond?",
  },
  {
    icon: "🂩",
    name: "Nine of Spades",
...
• No one ever hears from that person again.",
  },
  {
    ...
    name: "Nine of Hearts",
    desc:
      "A charismatic young girl convinces many to help her with an elaborate scheme. What is it? Who joins her endeavors? Start a project to reflect. or... A charismatic young girl tries to tempt many into sinful or dangerous activity. Why does she do this? How does the community respond?",
  },
  {
    icon: "🃉",
  ...
  },
  {
    ...
    name: "Nine of Clubs",
    desc:
      "The community works constantly and as a result a project finishes early. or... A group goes out to explore the map more thoroughly, and finds something that had been previously overlooked.",
  },
  {
    icon: "🂪",
    name: "Ten of Spades",
...
• Bar them from entry. What Scarcity could they have addressed? How does its need become more dire this week?",
  },
  {
    ...
    name: "Jack of Hearts",
    desc:
      "You see a good omen. What is it? or... You see a bad omen. What is it?",
  },
  {
    icon: "🃋",
...
If there are no projects underway, restlessness creates animosity, and animosity leads to violence. Who gets hurt?",
  ...
  },
  {
    ...
    desc:
      "What’s the most beautiful thing in this area? or... What’s the most hideous thing in this area?",
  },
  {
    icon: "🃍",
...
• Nobody knows what to do about it. Add “Health and Fertility” as a Scarcity.",
  ...
  },
  {
    ...
    name: "King of Hearts",
    desc:
      "A young boy starts digging in the ground, and discovers something unexpected. What is it? or... An old man confesses to past crimes and atrocities. What has he done?",
  },
  {
    icon: "🃎",
